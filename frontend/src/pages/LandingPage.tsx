...
//       {/* Header */}
//       <header className="sticky top-0 z-50 w-full border-b bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/90 border-border">
...
//               </div>
//               <span className="text-xl font-bold text-foreground">SignMeNow</span>
//             </div>
